...
#Set file path
path_restart="./restart/"                              # We need to create a folder
path_output="./output/"                                # We need to create a folder
path_output_final="./output_final/"                    # We need to create a folder 
path_obs="./Bondville_obs_2001.dat"                    # We need to prepare observation data 
...
for ii in range(0,istep):
    ...
    MPTABLE_0=open(path_MPTABLE)
    MPTABLE_data=MPTABLE_0.readlines()
    idd5=find_all_index(MPTABLE_data,'VCMX25')
    id5=idd5[1]
    MPTABLE_data_line=MPTABLE_data[id5]
    
    if ii==0:
        vcmax25_num=round(100.0,1)
        MPTABLE_data_line=" VCMX25=  50.0,   60.0,   60.0,   60.0,   55.0,   40.0,   40.0,   40.0,   40.0,   40.0,   50.0,   "+ str(('%.1f'%vcmax25_num))+ ",   0.00,   60.0,   0.00,   0.00,   0.00,   50.0,   50.0,   50.0,"+"\n"
